...
The majority of related work that exists focuses on strategies for designing prompts as well as
challenges users may face in the course of doing so.
...
Interest in query optimization in order to improve output exists ever since the availability of large search engines
to billions of users.
Huang and Efthimiadis~\cite{brown_language_2020} investigated query reformulation strategies in as early as 2009.
...
% TODO necessary or out of scope?
