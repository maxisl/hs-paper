...
opportunistic than strategic~\cite{zamfirescu-pereira_why_2023}.
...
A final aspect we want to highlight in the context of user interaction with LLMs are prompt
design applications with the goal of assisting users in prompt engineering.
