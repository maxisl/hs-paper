...
Currently, there is no single design interface or definite guidelines, which would help non-technical
users in particular.
To do so, example propositions include detecting keywords in prompt formulation and allowing
edits of those via a dropdown menu.
providing hints during prompt formulation, autocompletion,
