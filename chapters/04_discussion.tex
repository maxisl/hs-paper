...
They include examples and tips such as using explicit constraints, such as format, length, or scope
, to guide the model's behavior, leveraging specific instructions to improve responses, and ensuring ethical
