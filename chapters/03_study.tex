...
LLMs.
First, we examine 50 user interactions with ChatGPT, a generative Natural Language Processing
model.
These conversations were obtained from the website ShareGPT\cite{sharegpt_sharegpt_2023}.
ShareGPT is a platform, that allows its community to publicly share conversations they have had
with the ChatGPT model.
The entire shared conversation can then be viewed by the observer as if they had personally
conducted the interaction, which allows us to gain an extensive understanding of the conversation dynamics and
outcome.
As of today, ShareGPT has stored almost 300.000 user conversations, from which we have picked 50
random samples.
