...
% What is a text-to-image generation tool? What does it look like?
Text-to-image AI tools have seen significant developments in recent years as well.
...
To properly analyze prompting, it is crucial to distinguish different
types of prompts, as they are a key characteristic for a correct analysis and assessment in
...
settings compared to other settings where more information is provided in the prompt, such as a
few shot approach~\cite[p. 5]{brown_language_2020}.
...
In addition to the prompting setting, many other characteristics of prompts are conceivable for a
dedicated analysis.
We will present select categories and justify their use for our analysis in Section~\ref{subsec:research-method:-sharegpt-and-midjourney}.
