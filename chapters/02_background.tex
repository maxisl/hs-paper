...
Prompt design in general is still challenging for most users.
Observations show that non-experts approach prompting rather opportunistic than
strategic~\cite{zamfirescu-pereira_why_2023}.
Trials with user revealed that two main reasons for these problems.
First of all, non-experts showed over-generalization based on past, limited experiences,
or single observations of success and failure of prompt changes which may not be universally
transferable.
Second, a false comprehension of AI systems as human-like.
Participants in studies expected AI models to behave as in a human-to-human interaction, presuming a
