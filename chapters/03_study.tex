...
Users can interact with the model via Discord and execute individual prompts. % TODO cite
In order to generate an illustration, a user simply enters a descriptive prompt, similar to ChatGPT\@.
The prompt typically includes everything that should be visible in the picture, but can also
encompass the desired mood, drawing style, or composition of the generated image.
Notably, the Midjourney Bot does not understand grammar, sentence structure, or words like humans. % TODO cite
