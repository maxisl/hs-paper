...
Designing effective prompts that achieve the desired output is challenging for most users.
Observations show that non-experts approach prompting generally rather opportunistic than
strategic~\cite{zamfirescu-pereira_why_2023}.
Related user trials revealed two main reasons for these problems:
\begin{enumerate}
    ...
    transferable.
    This could clearly be observed in the above study when \("\)participants often stopped iterating
    ...
    % TODO remove First of all and second? redundant?
    \item Second, a false comprehension of AI systems as human-like counterparts.
    Participants in studies expected AI models to behave as in a human-to-human interaction,
    presuming social understanding.
    They avoided consequently following general best practices in prompt design such as providing
    examples, and instead relied on
\end{enumerate}
