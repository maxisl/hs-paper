...
Finally, we present said results and provide insights based on the collected data.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RESEARCH OBJECTIVE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Users can interact with the model through Discord \cite{discord_discord_2023} and submit
individual requests.
