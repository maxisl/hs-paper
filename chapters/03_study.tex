...
LLMs.
First, we examine 50 user interactions with ChatGPT, a generative NLP model.
...
As of today, ShareGPT has stored nearly 300.000 user conversations, from which we have selected 50
random samples.
What makes ShareGPT particularly suitable for our use-case is the fact that the entire shared conversation
can then be viewed by the observer as if they had personally conducted the interaction, which
allows us to gain an extensive understanding of the conversation dynamics and
outcome.
